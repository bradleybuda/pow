...
(function() {
  ...
  module.exports = HttpServer = (function(_super) {
    var o, renderResponse, renderTemplate, sslConfig, x;
    ...
    function HttpServer(configuration) {
      ...
      HttpServer.__super__.constructor.call(this, sslConfig, [o(this.logRequest), o(this.annotateRequest), o(this.handlePowRequest), o(this.findHostConfiguration), o(this.handleStaticRequest), o(this.findRackApplication), o(this.handleProxyRequest), o(this.handleRvmDeprecationRequest), o(this.handleApplicationRequest), x(this.handleErrorStartingApplication), o(this.handleFaviconRequest), o(this.handleApplicationNotFound), o(this.handleWelcomeRequest), o(this.handleRailsAppWithoutRackupFile), o(this.handleLocationNotFound)]);
      this.staticHandlers = {};
